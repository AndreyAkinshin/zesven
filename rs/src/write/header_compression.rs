...
///
/// A free function rather than a method: the async writer builds the same
/// archive from the same model and has to compress its header the same way,
/// and a second implementation of this is a second set of bytes.
#[cfg(feature = "lzma2")]
